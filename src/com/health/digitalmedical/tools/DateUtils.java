...
public class DateUtils
{
	...
	/**
	 * 判断是上午还是下午 true：是下午，false是上午
	 * @param dateStr xxx:12:00:00
	 * @return
	 */
	public static boolean checkDay(String dateStr)
	{
		try
		{
			Date date = CHN_DATE_TIME_EXTENDED_FORMAT.parse(dateStr);
	...
	public static String getWeekOfStr(String dateStr)
	{
		Date date;
		try
		{
